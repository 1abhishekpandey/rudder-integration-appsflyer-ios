...
* In **Dependency Rule**, select **Up to Next Major Version** and enter `2.4.1` as the value, as shown:
...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "git@github.com/rudderlabs/rudder-integration-appsflyer-ios.git", from: "2.4.1")
    ],
    targets: [
